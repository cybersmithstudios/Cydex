      ...
      <div className="container mx-auto max-w-6xl space-y-12 animate-fadeIn">
        ...
        <div className="flex justify-center">
          <Button
            ...
            className="relative px-8 py-6 text-lg font-medium bg-[#AFFF64] hover:bg-[#9FEF54] text-black shadow-lg hover:shadow-xl transition-all duration-300 before:absolute before:inset-0 before:border before:border-gray-300 before:border-dashed before:translate-x-1 before:translate-y-1"
          >
            Shop Now
          </Button>
        </div>
